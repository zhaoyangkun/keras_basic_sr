...
def generate_sr_img_2(generator, lr_img):
    ...
    lr_img = tf.convert_to_tensor(lr_img,
                                  dtype=tf.float32)  # ndarray -> tensor
...
if __name__ == "__main__":
    ...
    srcnn = load_model(
        "F:/研究生资料/超分模型结果/srcnn/models/train/gen_model_epoch_200")
    vdsr = load_model("F:/研究生资料/超分模型结果/vdsr/models/train/gen_model_epoch_200")
    srgan = load_model(
        "F:/研究生资料/超分模型结果/srgan/models/train/gen_model_epoch_100")
    esrgan = load_model(
        "F:/研究生资料/超分模型结果/esrgan/models/train/gen_model_epoch_100")
    ha_esrgan = load_model(
        "F:/研究生资料/超分模型结果/ha-esrgan/models/train/gen_model_epoch_100")
    generate_area_sr_img(
        ...
        "./image/RealSR_JPEG/butterfly.png",
